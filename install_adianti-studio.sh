#!/bin/bash
#Download e instalação do PHP-GTK e do Adianti Studio Pro 7.0.0 no Ubuntu 18.04, 20.04 e 20.10
#https://github.com/bjverde/adiantiStudioInstall
...
echo -e "${LGREEN} https://github.com/bjverde/adiantiStudioInstall ${NC}"
echo -e "\n"
echo -e "\n"
